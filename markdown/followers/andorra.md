...
The `number of followers` of users in Andorra on `2023/8/4 9:16 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
